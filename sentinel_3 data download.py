...
# sentinel-2数据下载函数
def sentinel_3_data(user_name,user_password,sentinel_url,start_date,end_date,platformname):
    '''
...
if __name__ == '__main__':
    ...
    # 数据类型
    producttype = 'SR_1_SRA___'#可选: Sentinel-3: SR_1_SRA___, OL_1_EFR___, SR_1_SRA_BS, SR_2_LAN___, OL_1_EFR___, OL_1_ERR___, OL_2_LFR___, OL_2_LRR___, SL_1_RBT___, SL_2_LST___, SY_2_SYN___, SY_2_V10___, SY_2_VG1___, SY_2_VGP___, SY_2_AOD__, SL_2_FRP__.
    sentinel_3_data(user_name, user_password, sentinel_url, start_date, end_date, platformname
                      )
